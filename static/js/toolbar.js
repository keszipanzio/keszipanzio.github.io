...
(function(){
  ...
  function startSnapShotSaving() {
    $('wm-save-snapshot-open').style.display='none';
    $('wm-save-snapshot-in-progress').style.display='inline-block';
    $('wm-save-snapshot-success').style.display='none';
    $('wm-save-snapshot-fail').style.display='none';
  }

  function successSnapshotSaving() {
    $('wm-save-snapshot-open').style.display='inline-block';
    $('wm-save-snapshot-in-progress').style.display='none';
    $('wm-save-snapshot-success').style.display='inline-block';
    $('wm-save-snapshot-fail').style.display='none';
  }
  ...
  function failSnapshotSaving(err) {
    ...
    $('wm-save-snapshot-in-progress').style.display='none';
    $('wm-save-snapshot-success').style.display='none';
    $('wm-save-snapshot-fail').style.display='inline-block';
  }
